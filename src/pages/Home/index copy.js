...
const ImageStyle = styled.div`
    .Product_productimage__1YT6P img {
        object-fit: cover;
        width: 152px;
        max-width: 152px;
        height: auto;
		...
		return (
			<ImageStyle>
				<div className={Styles.home}>
					{this.props.match.params.isLogin.substring(1, this.props.match.params.isLogin.length + 1) == 'true' &&
						<Cart isOpen={this.state.showCart} handleShowCart={this.handleShowCart} handleHideCart={this.handleHideCart} />
					}
					<div className={Styles.container}>
						<Header handleShowCart={this.handleShowCart} isLogin={this.props.match.params.isLogin.substring(1, this.props.match.params.isLogin.length + 1)} />
						<div className={Styles.cardcontent}>
							...
							<div className={Styles.product}>
								...
								<div className={Styles.productlist}>
									<Product className={Styles.product_img} productimage="home/products/01.png" title="Spotify Premium - Assinatura 1 mês" price="R$ 17,00" discount="0" items={[{ icon: 'home/icons/eye.png' }, { icon: 'home/icons/computer.png' }]} />
